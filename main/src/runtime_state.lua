...
local RENAMED_FIELDS = {
	...
	humanAccessoriesAPIInstalled = "human_accessories_api_installed",
	humanModelAssignments = "human_model_assignments",
	humanNecktieAssignments = "human_necktie_assignments",
	humanNecklaceAssignments = "human_necklace_assignments",
...
local function new_state()
	return {
		...
		human_accessories_api_installed = false,
		human_model_assignments = {},
		human_necktie_assignments = {},
		human_necklace_assignments = {},

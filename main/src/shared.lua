...
function M.getState()
	...
	local created = {
		...
		vehicleTypesAPIInstalled = false,
		customVehicleTypesByIndex = {},
		nextCustomVehicleTypeIndex = 17,
		vehicleTypeInitHookRan = false,
		vehicleTypeModelAssignments = {},
		vehicleTypeAudioAssignments = {},
		buildCustomVehicleTypesSyncPayload = nil,
